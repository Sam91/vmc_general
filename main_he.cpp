...
int main(int argc, char *argv[])
{
  ...
  wf->set_spiral1( (double)atoi(argv[2])/(double)atoi(argv[3]) );
  ...
  wf->js[0] = atoi(argv[4 ])/100.; //j1a
  wf->js[1] = atoi(argv[5 ])/100.; //j2a
  wf->js[2] = atoi(argv[6 ])/100.; //j3
  //wf->js[3] = atoi(argv[9 ])/100.; //j1b
  //wf->js[4] = atoi(argv[10])/100.; //j2b
  //wf->js[5] = atoi(argv[11])/100.; //j1c
  //wf->js[6] = atoi(argv[12])/100.; //j2c

  //wf->jl = atoi(argv[13])/100.; //dogleg term

  //fix isotropic Jastrows
  //wf->js[5] = wf->js[3] = wf->js[0]; //j1
  //wf->js[6] = wf->js[4] = wf->js[1]; //j2
  //wf->js[5] = wf->js[0]; //j1
  //wf->js[6] = wf->js[4] = wf->js[1]; //j2


  //for(int n1=0; n1<15; n1++) //sweep over j1, j1b
  //{
    //wf->js[5] = wf->js[3] = wf->js[0] = atoi(argv[9])/100.;
    //wf->js[5] = wf->js[0] = atoi(argv[6])/100.;
