...
//scan rotationally invariant nn Jastrow factors
...
int main(int argc, char *argv[])
{
  ...
  wf->js[0] = atoi(argv[2 ])/100.; //j1a
  wf->js[1] = atoi(argv[3 ])/100.; //j2a
  ...
  for(int n1=0; n1<15; n1++) //sweep over j1, j2
  {
