...
#  cmd = "main_u1real_scan12 8 1 0 0 0 "+ str(xitot) +" -1 "+ str(xi3) +" 10",'',0
        ...
        #c-3, e2=1
        for ph2 in range(0, 501, 150):
          if ph==0 and ph2==0:
            continue 
          t_name = 'c3- '+str(x3sgn)+'_'+str(x2sgn)+'_'+str(ph)+'_'+str(ph2)+'_'+str(xitot).zfill(2)
          #cmd = "main_u1compl_scan12 8 1 0 0 0 0 1 "+ str(xitot) +" "+ str(x2sgn) +" "+ str(xi3) +" "+ str(ph) +" "+ str(ph2) +" 0 10"
          cmd = "main_u1compl_scan12 8 1 0 1 0 0 1 "+ str(xitot) +" "+ str(x2sgn) +" "+ str(xi3) +" "+ str(ph) +" "+ str(ph2) +" 300 10"
